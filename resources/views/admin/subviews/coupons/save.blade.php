<?php
    ...
    */
    ...
    if (is_object($item_data)) {
        $header_text    = "Edit ".front_tf($item_data->coupon_title);
        $item_id        = $item_data->coupon_id;
    }
        ...
        <div class="section-wrapper">
            <?php if(havePermission("admin/coupons","add_action")): ?>
                <label class="section-title">
                    <a class="btn btn-primary mg-b-6" href="{{url("admin/coupons/save")}}"> Add New <i class="fa fa-plus"></i></a>
                </label>
            <?php endif; ?>
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/coupons/save/$item_id")}}" method="POST" enctype="multipart/form-data">
