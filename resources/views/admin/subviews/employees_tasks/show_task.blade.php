    ...
    <div class="container-fluid">
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url("admin/employees-tasks")}}">Employees Tasks</a></li>
                <li class="breadcrumb-item active" aria-current="page">Employee Task</li>
            </ol>
            <h6 class="slim-pagetitle">Employee Task</h6>
        </div><!-- slim-pageheader -->
                ...
                <div class="col-md-4" style="font-size: 15px; font-weight: bold; color: black">
                    Status :
                     <span style="color: #868ba1; margin-left: 10px">
                        <?php if($task->task_status == 'under_review' && havePermission("admin/employees_tasks", "accept_task")): ?>
                            ...
                            <div class="card-body p-2">
                                <div class="ml-3 mt-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <?php if(havePermission("admin/employees_tasks_comments","delete_action") && auth()->user()->user_id == $comment->user_id): ?>
                                                <a href='#confirmModal'
                                                   ...
                                                   data-deleteurl="{{url("/admin/employees-tasks-comments/delete")}}"
        ...
        <div class="section-wrapper mb-4">
            ...
            <form class="ajax_form" action="{{url("admin/employees-tasks-comments/add")}}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
