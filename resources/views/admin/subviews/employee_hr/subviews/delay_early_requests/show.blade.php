...
<div class="slim-mainpanel">
    <div class="container-fluid">
        ...
        <div class="section-wrapper mb-3">
            ...
            <?php if(havePermission("admin/my_hr_delay_early_requests", "add_action")): ?>
                <label class="section-title">
                    <a class="btn btn-primary mg-b-6" href="{{url("admin/employee-hr/delay-early-requests/save?type=$type")}}">
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                echo generate_select_tags_v2([
                                    ...
                                    "label_name"              => "Request Status",
                                    "text"                    => ["All", "Pending", "Accepted", "Rejected"],
