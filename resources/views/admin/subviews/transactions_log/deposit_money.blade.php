<?php
    ...
    $header_text    = "Deposit Money To - ".$wallet_owner_name;
?>
    ...
    <div class="container-fluid">
        ...
        <div class="section-wrapper">
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/transactions-log/deposit-money/$wallet_owner_name/$item_data->wallet_id")}}" method="POST" enctype="multipart/form-data">
