    ...
    <div class="container-fluid">
        ...
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sales Count By Products</li>
            </ol>
            <h6 class="slim-pagetitle">Sales Count By Products {{$report_type_date}}</h6>
        </div><!-- slim-pageheader -->
        ...
        <a href="{{url("admin/reports/sold-products-yearly")}}" class="btn btn-info" >Yearly</a>
        <a href="{{url("admin/reports/sold-products-monthly")}}" class="btn btn-info" >Monthly</a>
        <a href="{{url("admin/reports/sold-products?date_from=" . $dayFrom7Pasts . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Weekly</a>
        <a href="{{ url("admin/reports/sold-products?date_from=" . date("Y-m-d") . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Daily</a>
        <p class="mb-2"></p>
