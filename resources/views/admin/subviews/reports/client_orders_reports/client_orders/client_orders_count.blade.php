...
<div class="slim-mainpanel">
    <div class="container-fluid">
        <div class="slim-pageheader">
            ...
            <h6 class="slim-pagetitle"> Branches Orders Count {{$report_type_date}}</h6>
        </div><!-- slim-pageheader -->
        ...
        <a href="{{url("admin/reports/client-orders-count-yearly")}}" class="btn btn-info" >Yearly</a>
        <a href="{{url("admin/reports/client-orders-count-monthly")}}" class="btn btn-info" >Monthly</a>
        <a href="{{url("admin/reports/client-orders-count?date_from=" . $dayFrom7Pasts . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Weekly</a>
        <a href="{{ url("admin/reports/client-orders-count?date_from=" . date("Y-m-d") . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Daily</a>
        <p class="mb-2"></p>
                    ...
                    <table id="datatable2" class="table display ">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p"><span>Total orders</span></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php
                              $totalClientChartData[$item->item_name] = $item->total_count;
        ...
        @if(isset($totalClientChartData))
            <div class="section-wrapper mb-3">
                <div class="row">
                    <div class="col-md-12">
                        <div id="total_client_chart_data" data-value="{{json_encode($totalClientChartData)}}" data-title=" Branches total orders  {{$report_type_date}}" class="google_chart draw_bie_chart" style="height: 600px;"></div>
                    </div>
                </div>
            </div>
        @endif
