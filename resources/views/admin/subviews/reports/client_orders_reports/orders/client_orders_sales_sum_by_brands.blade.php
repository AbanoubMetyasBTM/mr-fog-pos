    ...
    <div class="container-fluid">
        ...
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sales Sum By Brands</li>
            </ol>
            <h6 class="slim-pagetitle">Sales Sum By Brands {{$report_type_date}}</h6>
        </div><!-- slim-pageheader -->
        ...
        <a href="{{url("admin/reports/orders-items-brands-sales-sum-yearly")}}" class="btn btn-info" >Yearly</a>
        <a href="{{url("admin/reports/orders-items-brands-sales-sum-monthly")}}" class="btn btn-info" >Monthly</a>
        <a href="{{url("admin/reports/orders-items-brands-sales-sum?date_from=" . $dayFrom7Pasts . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Weekly</a>
        <a href="{{ url("admin/reports/orders-items-brands-sales-sum?date_from=" . date("Y-m-d") . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Daily</a>
        <p class="mb-2"></p>
                        ...
                        <tbody>
                            <?php foreach ($report_sold_products_buy as $key => $item): ?>
                                <?php
                                    ...
                                    $SUMOrdersBrandsChartData[$item->item_name] = $total_amount;
        ...
        @if(isset($orders_brands) && isset($report_sold_products_return))
            <div class="section-wrapper mb-3">
                <div class="row">
                    <div class="col-md-6">
                        <?php
