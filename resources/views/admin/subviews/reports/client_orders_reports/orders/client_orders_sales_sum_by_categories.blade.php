    ...
    <div class="container-fluid">
        ...
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sales Sum By Categories</li>
            </ol>
            <h6 class="slim-pagetitle">Sales Sum By Categories {{$report_type_date}}</h6>
        </div><!-- slim-pageheader -->
        ...
        <a href="{{url("admin/reports/orders-items-categories-sales-sum-yearly")}}" class="btn btn-info" >Yearly</a>
        <a href="{{url("admin/reports/orders-items-categories-sales-sum-monthly")}}" class="btn btn-info" >Monthly</a>
        <a href="{{url("admin/reports/orders-items-categories-sales-sum?date_from=" . $dayFrom7Pasts . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Weekly</a>
        <a href="{{ url("admin/reports/orders-items-categories-sales-sum?date_from=" . date("Y-m-d") . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Daily</a>
        <p class="mb-2"></p>
                        ...
                        <tbody>
                            <?php foreach ($report_sold_products_buy as $key => $item): ?>
                                <?php
                                    ...
                                    $total_amount       = (int)$item->total_items_cost - (int)($returnQuantity->total_items_cost ?? 0);

                                    $SUMOrdersCategoryChartData[$item->item_name] = $total_amount;
