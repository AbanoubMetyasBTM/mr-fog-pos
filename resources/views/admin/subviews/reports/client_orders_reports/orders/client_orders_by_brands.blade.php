 ...
 * @var \Illuminate\Support\Collection $sum_orders_brands
    ...
    <div class="container-fluid">
        ...
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sales Count By Brands</li>
            </ol>
            <h6 class="slim-pagetitle">Sales Count By Brands {{$report_type_date}}</h6>
        </div><!-- slim-pageheader -->
        ...
        <a href="{{url("admin/reports/orders-items-brands-quantities-yearly")}}" class="btn btn-info" >Yearly</a>
        <a href="{{url("admin/reports/orders-items-brands-quantities-monthly")}}" class="btn btn-info" >Monthly</a>
        <a href="{{url("admin/reports/orders-items-brands-quantities?date_from=" . $dayFrom7Pasts . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Weekly</a>
        <a href="{{ url("admin/reports/orders-items-brands-quantities?date_from=" . date("Y-m-d") . "&date_to=" . date("Y-m-d"))}}" class="btn btn-info" >Daily</a>
        <p class="mb-2"></p>
        ...
        <div class="section-wrapper mb-3">
            ...
            <div class="table-wrapper">
                ...
                <?php if($sum_orders_brands->count()): ?>
                        ...
                        <tbody>
                            <?php foreach ($report_sold_products_buy as $key => $item): ?>
                                <?php
                                    ...
                                    $SUMOrdersBrandsChartData[$item->item_name] = $quantity;
        ...
        @if(isset($SUMOrdersBrandsChartData))
            <div class="section-wrapper mb-3">
                <div class="row">
                    <div class="col-md-12">
                        <div id="yearly_sold_products_chart_id" data-value="{{json_encode($SUMOrdersBrandsChartData)}}" data-title="{{$report_type_date}} Sold Products" class="google_chart draw_bar_chart" style="height: 600px;"></div>
                    </div>
                </div>
            </div>
        @endif
        ...
        @if(isset($sum_orders_category) && isset($report_sold_products_return))
            <div class="section-wrapper mb-3">
                <div class="row">
                    <div class="col-md-6">
                        <?php
