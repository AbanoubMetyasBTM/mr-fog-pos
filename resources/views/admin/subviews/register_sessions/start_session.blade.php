...
<div class="slim-mainpanel">
    <div class="container-fluid">
        ...
        <div class="section-wrapper">
            ...
            <label class="section-title">Session Start Data</label>

            <p class="mg-b-20 mg-sm-b-20"></p>
            <div class="table-wrapper">

                <form id="save_form" class="ajax_form" action="{{url("admin/register-sessions/start-session/$register_id")}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                            ...
                            <div class="section-wrapper mg-y-20">
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        $attrs[3]["register_start_cash_amount"]  = "number";
