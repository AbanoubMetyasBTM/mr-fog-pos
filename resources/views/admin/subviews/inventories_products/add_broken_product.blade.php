<?php
    ...
    $header_text        = "Add Broken Product";
?>
    ...
    <div class="container-fluid">
        ...
        <div class="section-wrapper">
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/inventories-products/add-broken-product")}}" method="POST" enctype="multipart/form-data">
