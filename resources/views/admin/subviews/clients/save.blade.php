<?php
    ...
    */
    ...
    if (is_object($item_data)) {
        $header_text    = "Edit ".$item_data->client_name;
        $item_id        = $item_data->client_id;
    }
        ...
        <div class="section-wrapper">
            <?php if(havePermission("admin/clients","add_action")): ?>
                <label class="section-title">
                    <a class="btn btn-primary mg-b-6" href="{{url("admin/clients/save")}}"> Add New <i class="fa fa-plus"></i></a>
                </label>
            <?php endif; ?>
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/clients/save/$item_id")}}" method="POST" enctype="multipart/form-data">
