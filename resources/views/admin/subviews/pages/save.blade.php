    ...
    <div class="container-fluid">
        <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url("admin/site-pages")}}">Pages</a></li>
        ...
        <div class="section-wrapper">
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/site-pages/save/$page_id")}}" method="POST" enctype="multipart/form-data">
