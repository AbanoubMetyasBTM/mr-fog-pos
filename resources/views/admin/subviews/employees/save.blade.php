<?php
    ...
    */
    ...
    if (is_object($item_data)) {
        ...
        echo "<input hidden name='emp_id' value='$item_data->employee_id'>";
    }
?>
        ...
        <div class="section-wrapper">
            <?php if(havePermission("admin/employees","add_action")): ?>
                <label class="section-title">
                    <a class="btn btn-primary mg-b-6" href="{{url("admin/employees/save")}}"> Add New <i class="fa fa-plus"></i></a>
                </label>
            <?php endif; ?>
            ...
            <div class="table-wrapper">
                ...
                <form id="save_form" class="ajax_form" action="{{url("admin/employees/save/$item_id")}}" method="POST" enctype="multipart/form-data">
                    ...
                    <?php if(is_object($item_data)): ?>
                        <input hidden name='emp_id' value='{{$item_data->employee_id}}'>
                    <?php endif; ?>
