...
class EmployeesController extends AdminBaseController
{
    ...
    public function beforeAddNewRow(Request $request)
    {
        ...
        User::where('user_id', '=', $userObj->user_id)->update(array('user_enc_id' => $userEncId));
    ...
    public function beforeUpdateRow(Request $request)
    {
        ...
        if ($this->branch_id!=null && $itemObj != null&&$itemObj->branch_id!=$this->branch_id){
            abort(404);
            die();
        }
    ...
    public function getEmployeeData(Request $request)
    {
        ...
        if ($this->branch_id != null &&  (empty($data) || $employeeObj->branch_id != $this->branch_id)){
            abort(404);
            die();
        }
